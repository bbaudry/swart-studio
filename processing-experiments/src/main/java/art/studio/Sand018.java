...
public class Sand018 extends PApplet {
  ...
  private void organ() {
    ...
    for (int vera = 0; vera < 2; vera++) {
      beauty = fSize + alea.nextFloat()*7; // random choice of the height of the rect
      
      text(art_pieces[alea.nextInt(art_pieces.length)],john, baldessari);
  ...
  public static void main(String[] args) {
    String[] processingArgs = { "Sand018" };
    Sand018 mySketch = new Sand018();
