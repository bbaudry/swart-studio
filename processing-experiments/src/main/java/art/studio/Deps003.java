/* Metadata {"endless":false, "BW": true, "knobs": false, "data": true, "interaction": false}*/
package art.studio;
...
public class Deps003 extends PApplet{
    int w = 1000;
    int h = 1000;
    float x;
    float y;
    ...
    public static void main(String[] args) {
        String[] processingArgs = { "Deps003"};
        Deps003 mySketch = new Deps003();
