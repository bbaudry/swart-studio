...
public class Practice015  extends PApplet {
    ...
    public void draw() {
        ...
        eliane = 5; //width of a stripe
        steps = 272; //number of stripes
        ...
        eliane = 19; //width of a stripe
        steps = 42; //number of stripes
        //coordinates of origin and destination of one stripe
        cx1 = 0; cy1 = h; 
        cx2 = w; cy2 = (float)0.8*h;
        inc = (float)1/steps;
        for(int i=0; i<steps; i++){ 
            cx3=cx1+(i*eliane); 
            cy3=cy1;
