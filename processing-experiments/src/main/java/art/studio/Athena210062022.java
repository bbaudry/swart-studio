...
public class Athena210062022 extends PApplet {
    int w = 1000;
    int h = 1000;
    float cx;
    float cy;
    ...
    public void draw() {
        ...
        frameRate(2);
        noLoop();
        save("Athena210062022.png");
    }

    private void chercheur() {
        int constellation = (int)random(21);
        float angle;
    ...
    public static void main(String[] args) {
        String[] processingArgs = { "Athena210062022 " };
        Athena210062022 mySketch = new Athena210062022();
