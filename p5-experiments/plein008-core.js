...
function hal() {
    ...
    magics=[]
    xoff = 0.0; xinc = 0.001; magics.push({name:"xinc",val:xinc})
    angleinc = 55; magics.push({name:"angleinc",val:angleinc})
    diam = actualwidth * 0.01; diaminc = actualwidth * 0.008; magics.push({name:"diaminc",val:diaminc})
    while(diam<w*0.9){
        angle2 = 0
