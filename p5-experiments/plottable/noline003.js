...
function draw() {
    background(0, 0, 100)
    nucleus(leftmargin,topmargin,actualwidth*0.5,actualheight*0.5)
    nucleus(leftmargin+actualwidth*0.5,topmargin,actualwidth*0.5,actualheight*0.5)
    nucleus(leftmargin,topmargin+actualwidth*0.5,actualwidth*0.5,actualheight*0.5)
    nucleus(leftmargin+actualwidth*0.5,topmargin+actualwidth*0.5,actualwidth*0.5,actualheight*0.5)
    noLoop()
}
